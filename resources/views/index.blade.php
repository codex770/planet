...
<header class="masthead">
        ...
        <div id="data" class="hide-in-md">
            ...
            <a class="earth" title="earth" href="#earthspeed">Earth</a>
            <a class="mars active" title="mars" href="#marsspeed">Mars</a>
        ...
        <div id="universe" class="scale-stretched">
            <div id="galaxy">
                <div id="solar-system" class="mars">
    ...
    <a class="more-btn js-scroll-trigger" href="#more">ERKUNDE WEITER <i class="fas fa-chevron-down"></i></a>
    <!-- ERKUNDE WEITER -->
    <section class="page-section white-bg" id="more">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-3">
                    <div class="custom-column mb-3">
                        <div class="custom-column-header">INFORMATION 1</div>
                ...
                <div class="col-sm-12 col-md-3">
                    <div class="custom-column mb-3">
                        <div class="custom-column-header">INFORMATION 2</div>
                        <div class="custom-column-content">
                            <ul class="list-group">
                                <li class="list-group-item"><i class="fa fa-check"></i> Cras justo odio</li>
                                <li class="list-group-item"><i class="fa fa-check"></i> Dapibus ac facilisis in</li>
                ...
                <div class="col-sm-12 col-md-3">
                    <div class="custom-column mb-3">
                        <div class="custom-column-header">INFORMATION 3</div>
                        <div class="custom-column-content">
                            <ul class="list-group">
                                <li class="list-group-item"><i class="fa fa-check"></i> Cras justo odio</li>
                                <li class="list-group-item"><i class="fa fa-check"></i> Dapibus ac facilisis in</li>
                ...
                <div class="col-sm-12 col-md-3">
                    <div class="custom-column mb-3">
                        <div class="custom-column-header">INFORMATION 4</div>
                        <div class="custom-column-content">
                            <ul class="list-group">
                                <li class="list-group-item"><i class="fa fa-check"></i> Cras justo odio</li>
                                <li class="list-group-item"><i class="fa fa-check"></i> Dapibus ac facilisis in</li>
    ...
    <!-- Services Section -->
    <section class="page-section white-bg pb-5" id="services">
        <div class="container">
            <h2 class="text-center mt-0">10 Need-to-Know Things</h2>
            <hr class="divider my-4">
            <div class="row">
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        <div class="digit-icon">1</div>
                        <h3 class="h4 mb-2">SMALL PLANET</h3>
                        <p class="text-muted mb-0 p-16px">If the Sun were as tall as a typical front door, Earth
                            would
                            be the size
                            of a dime, and Mars would be about as big as an aspirin tablet.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        <div class="digit-icon">2</div>
                        <h3 class="h4 mb-2">FOURTH ROCK</h3>
                        <p class="text-muted mb-0 p-16px">Mars orbits our Sun, a star. Mars is the fourth planet
                            from
                            the Sun at an
                            average distance of about 228 million km (142 million miles) or 1.52 AU.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        <div class="digit-icon">3</div>
                        <h3 class="h4 mb-2">LONGER DAYS</h3>
                        <p class="text-muted mb-0 p-16px">One day on Mars takes a little over 24 hours. Mars makes a
                            complete orbit
                            around the Sun (a year in Martian time) in 687 Earth days.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        <div class="digit-icon">4</div>
                        <h3 class="h4 mb-2">RUGGED TERRAIN</h3>
                        <p class="text-muted mb-0 p-16px">Mars is a rocky planet. Its solid surface has been altered
                            by
                            volcanoes,
                            impacts, winds, crustal movement and chemical reactions.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Contact Section -->
    <section class="page-section footer-section white-color" id="contact">
        <div class="container">
