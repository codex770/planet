                                                          ...
                                                          <tr>
                                                            <td>
                                                              <table width="170" cellspacing="0" cellpadding="0" border="0" align="center">
                                                                <tbody>
                                                                  <tr>
                                                                    <td><a href="#" style="text-decoration:none;"><img src="{{ asset('logo.png') }}"></a></multiline></td>
                                                                  </tr>
                                                                </tbody>
                                                              </table>
                                                            </td>
                                                            ...
                                                            <tr>
                                                                <td style="font-family:'Open Sans', sans-serif, Verdana; font-size:20px; color:#3b3a3a; font-weight:bold; line-height:50px; text-transform:none;" mc:edit="fm-40" valign="top" align="center">
                                                                    <multiline>Reset Your Password</multiline>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td style="font-family:'Open Sans', sans-serif, Verdana; font-size:14px; color:#3b3a3a; font-weight:normal; line-height:24px;" mc:edit="fm-41" valign="top" align="left">
                                                                    <strong>Hello {{ ucfirst($full_name) }}</strong>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="font-family:'Open Sans', sans-serif, Verdana; font-size:14px; color:#3b3a3a; font-weight:normal; line-height:24px;" mc:edit="fm-41" valign="top" align="left">
                                                                    <multiline>We recently got your password reset request, if that is not your then no action is required. But for your security it will be great to change your password. if that was your then below is the secret code you will need to reset your password.</multiline>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                  <table width="170" cellspacing="0" cellpadding="0" border="0" align="center">
                                                                                    <tbody>
                                                                                      <tr>
                                                                                        <td style="font-family:'Open Sans', sans-serif, Verdana; font-size:18px; color:#fff; font-weight:bold; line-height:12px; text-transform:uppercase; background-color: #ffc31d" data-bgcolor="download-bg" mc:edit="fm-20" valign="middle" height="40" bgcolor="#f41f74" align="center"><multiline><a href="{{ url('job').'/'.$job_id }}" style="text-decoration:none; color:#fff;">View Job</a></multiline></td>
                                                                                      </tr>
                                                                                    </tbody>
                                                                                  </table>
                                                                                </td>
