...
@section('content') 
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center text-white">
                        <h1 class="mt-5 font-responsive">Planet Mercury</h1>
        ...
        <section class="page-section top-slider-home">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="item">
                            <h6 class="font-color-mercury">{{$slider->name}}</h6>
    ...
    <a class="more-btn js-scroll-trigger" style="background-color: #8a8887; color:#fff;" href="#more">ERKUNDE WEITER <i class="fas fa-chevron-down ml-2"></i></a>
        ...
        <div class="container pt-5">
            <div class="row">
                <div class="col-md-12 ">
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-2  text-center text-bg-color-mercury">
...
@push('scripts')
    ...
    <!-- planet related -->
    <script src="{{ asset('assets/mercury/js/three.min.js')}}"></script>
    <script src="{{ asset('assets/mercury/js/controls/OrbitControls.js')}}"></script>
    <script src="{{ asset('assets/mercury/js/loaders/GLTFLoader.js')}}"></script>

    <script src="{{ asset('assets/mercury/app.js')}}"></script>
    <script src="{{ asset('assets/mercury/js/lights.js')}}"></script>
@endpush