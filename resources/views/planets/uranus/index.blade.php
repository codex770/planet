        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center text-white">
                    <h1 class="mt-5 font-responsive">Planet Uranus</h1>
    ...
    <section class="page-section top-slider-home">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="item">
                        <h6 class="font-color-uranus">{{$slider->name}}</h6>
...
<a class="more-btn js-scroll-trigger" style="background-color: #16c6e9; color: #fff;" href="#more">ERKUNDE WEITER <i
    ...
    <div class="container pt-5">
        <div class="row">
            <div class="col-md-12 ">
                ...
                <div class="row">
                    <div class="col-md-12 mt-2  text-center text-bg-color-uranus">
...
<!-- planet related -->
<script src="{{ asset('asset/uranus/js/three.min.js')}}"></script>
<script src="{{ asset('asset/uranus/js/controls/OrbitControls.js')}}"></script>
<script src="{{ asset('asset/uranus/js/loaders/GLTFLoader.js')}}"></script>

<script src="{{ asset('asset/uranus/app.js')}}"></script>
<script src="{{ asset('asset/uranus/js/lights.js')}}"></script>
@endpush
