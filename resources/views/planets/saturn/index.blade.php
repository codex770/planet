...
@section('content') 
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center text-white">
                        <h1 class="mt-5 font-responsive">Planet Satrun</h1>
        ...
        <section class="page-section top-slider-home">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="item">
                            <h6 class="font-color-saturn">{{$slider->name}}</h6>
    ...
    <a class="more-btn js-scroll-trigger" style="background-color: #eba357;" href="#more">ERKUNDE WEITER <i class="fas fa-chevron-down ml-2"></i></a>
        ...
        <div class="container pt-5">
            <div class="row">
                <div class="col-md-12 ">
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-2  text-center text-bg-color-satrun">
...
@push('scripts')
    ...
    <!-- planet related -->
    <script src="{{ asset('asset/saturn/js/three.min.js')}}"></script>
    <script src="{{ asset('asset/saturn/js/controls/OrbitControls.js')}}"></script>
    <script src="{{ asset('asset/saturn/js/loaders/GLTFLoader.js')}}"></script>

    <script src="{{ asset('asset/saturn/app.js')}}"></script>
    <script src="{{ asset('asset/saturn/js/lights.js')}}"></script>
@endpush