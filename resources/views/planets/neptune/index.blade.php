        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center text-white">
                    <h1 class="mt-5 font-responsive">Planet Neptune</h1>
    ...
    <section class="page-section top-slider-home">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="item">
                        <h6 class="font-color-neptune">{{$slider->name}}</h6>
...
<a class="more-btn js-scroll-trigger" style="background-color: #97b7ff; color: #fff;" href="#more">ERKUNDE WEITER <i
    ...
    <div class="container pt-5">
        <div class="row">
            <div class="col-md-12 ">
                ...
                <div class="row">
                    <div class="col-md-12 mt-2  text-center text-bg-color-neptune">
...
<!-- planet related -->
<script src="{{ asset('assets/neptune/js/three.min.js')}}"></script>
<script src="{{ asset('assets/neptune/js/controls/OrbitControls.js')}}"></script>
<script src="{{ asset('assets/neptune/js/loaders/GLTFLoader.js')}}"></script>

<script src="{{ asset('assets/neptune/app.js')}}"></script>
<script src="{{ asset('assets/neptune/js/lights.js')}}"></script>
@endpush
