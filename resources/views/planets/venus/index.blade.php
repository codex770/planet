...
@section('content') 
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center text-white">
                        <h1 class="mt-5 font-responsive">Planet Venus</h1>
        ...
        <section class="page-section top-slider-home">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="item">
                        <h6 class="font-color-venus">{{$slider->name}}</h6>
    ...
    <a class="more-btn js-scroll-trigger" style="background-color: #f6bb2b; color: #fff;" href="#more">ERKUNDE WEITER <i class="fas fa-chevron-down ml-2"></i></a>
        ...
        <div class="container pt-5">
            <div class="row">
                <div class="col-md-12 ">
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-2  text-center text-bg-color-venus">
...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/controls/OrbitControls.js')}}"></script>
    <script src="{{ asset('assets/js/loaders/GLTFLoader.js')}}"></script>

    <script src="{{ asset('assets/app.js')}}"></script>
    <script src="{{ asset('assets/js/lights.js')}}"></script>
@endpush